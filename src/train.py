...
optparser.add_option("-T", "--train", default="data/E-NER-Dataset-main/E-NER_train_10000.txt", help="Train set location")
...
optparser.add_option("--name", default="model_10k_train_ENER_transfer_adapter", help="model name")
...
def train():
    ...
    eval_every = 200
    count = 0
    vis = visdom.Visdom(server='http://10.2.56.213', port=8098)
    sys.stdout.flush()
